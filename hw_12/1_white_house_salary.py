...
#print(e.each_vacancy())rrrr
print(Employee.count)
print(Employee.staff)
print(Employee.all_salary)
#e.recount()        #Альтернативний підрахунок суми зарплат
#print(Emploee.all_salary)
del e.employees[0]
print(Employee.count)
print(Employee.staff)
print(Employee.all_salary)
#print(e.employees[56].status)
del e.employees[56] # цей запис має статус Detailee, перевірка чи відмінусуєть еймплої, якщо видалимо його
print(Employee.count) #ok
print(Employee.staff) #ok
print(Employee.all_salary) #ok
...
if ('$LastChangedDate: 2022-05-13 16:27:05 +0300 (пт, 13 тра 2022) $' =~ ':') {
  # Subversion keyword "$LastChangedDate: 2022-05-13 16:27:05 +0300 (пт, 13 тра 2022) $" has been successfully expanded.
  # Doesn't happen with automated launchpad builds:
  # https://bugs.launchpad.net/launchpad/+bug/780916
  $SUB_VERSION = (split(/\s+/,'$LastChangedDate: 2022-05-13 16:27:05 +0300 (пт, 13 тра 2022) $ updated by SVN'))[1];
}


if (defined $IS_DEVEL_BUILD && $IS_DEVEL_BUILD) {
  if ('$LastChangedRevision: 1900857 $' =~ ':') {
    # Subversion keyword "$LastChangedRevision: 1900857 $" has been successfully expanded.
    push(@EXTRA_VERSION, ('r' . qw{$LastChangedRevision: 1900857 $ updated by SVN}[1]));
  } else {
